...
TopRatedResults resultsFromJson(String str) => TopRatedResults.fromJson(json.decode(str));
String resultsToJson(TopRatedResults data) => json.encode(data.toJson());
...
TopRatedResults copyWith({  bool? adult,
  ...
  num? voteAverage,
  num? voteCount,
}) => TopRatedResults(  adult: adult ?? _adult,
