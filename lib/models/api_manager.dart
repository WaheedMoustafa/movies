...
class ApiManager {
  ...
  static Future<PopularModel> getTopMovies () async{
    ...
    final response = await http.get(Uri.parse('$_upcomingBaseUrl?apiKey=${Constants.apiKey}'));
    ...
    final response = await http.get(Uri.parse('$_topRatedBaseUrl?apiKey=${Constants.apiKey}'));
